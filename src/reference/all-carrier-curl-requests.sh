...
-d 'carrier_account[credentials][carrier_facility]=VALUE' \
-d 'carrier_account[credentials][password]=VALUE' \
-d 'carrier_account[credentials][sub_account_number]=VALUE' \
...
-d 'carrier_account[credentials][not_platform]=VALUE' \
-d 'carrier_account[test_credentials][api_key]=VALUE' \
