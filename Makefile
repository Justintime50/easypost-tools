...
install-java:
	...
	curl -LJs "https://search.maven.org/remotecontent?filepath=com/easypost/easypost-api-client/4.0.4/easypost-api-client-4.0.4.jar" -o src/examples/java/jars/easypost.jar
